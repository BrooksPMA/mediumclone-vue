...
// Мутации - синхронные экшены. Экшены - асинхорнные. В мутациях пишут только обращения к стейтам. В экшенах пишут что угодно. Экшены в основном используются для получения данных из API.
// Мутации, геттеры и экшены глобальные (нельзя исопользовать названия много раз и в других местах)
